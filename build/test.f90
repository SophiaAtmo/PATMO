program test
 ...
 call patmo_dumpFirstDensityToFile(56,t,patmo_idx_SO2)
 call patmo_dumpFirstDensityToFile(57,t,patmo_idx_COS)
...
!      write(27,*)  krate(i,63), krate(i,73), krate(i,74) 
 ...
 print '(F11.2,a2)',t/tend*1d2," %"
  ...
  !dump solar flux at different height (try to output solar flux at different height but dont know how)
!  call patmo_dumpPhotoFlux("SolarFluxDiffHeight.dat")
